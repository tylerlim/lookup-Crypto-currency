...
header_rank = Label(root, text="Rank", bg="#EAE1DF", font = "Verdana 8 bold")
...
header_price_paid = Label(root, text="Price Paid", bg="#EAE1DF", font = "Verdana 8 bold")
...
header_1_hr_change = Label(root, text="1 HR Change", bg="#EAE1DF", font = "Verdana 8 bold")
...
header_7_day_change = Label(root, text="7 Day Change", bg="#EAE1DF", font = "Verdana 8 bold")
...
header_profit_loss_total = Label(root, text="Profit/Loss Total", bg="#EAE1DF", font = "Verdana 8 bold")
	...
	for x in api:
		for coin in my_portfolio:
			if coin["sym"] == x["symbol"]:
				...
				rank = Label(root, text=x["rank"], bg="#EAE1DF")
				...
				price_paid = Label(root, text="${0:.2f}".format(float(coin["price_paid_per"])), bg="#EAE1DF")
				...
				one_hr_change = Label(root, text="{0:.2f}%".format(float(x["percent_change_1h"])), bg="#EAE1DF", fg=red_green(float(x["percent_change_1h"])))
				...
				seven_day_change = Label(root, text="{0:.2f}%".format(float(x["percent_change_7d"])), bg="#EAE1DF", fg=red_green(float(x["percent_change_7d"])))
				...
				profit_loss_total = Label(root, text="${0:.2f}".format(float(profit_loss)), bg="#EAE1DF", fg=red_green(float(profit_loss)))
